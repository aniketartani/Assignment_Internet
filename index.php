...
<html lang="en">
	...
	<body>
		<header id="go_to_top">
			<div class="gradient">
				<div class="container">
					<h2 id="logo"><a href="index.html"> SAP
						</a></h2>
		...
		<main>
			...
			<section id="reservation" class="breakpoint"> 
				<div class="content">
					...
					<h2><a href="reservation.php"> Make a reservation </a></h2>
				</div>
				<div class="img_container">
		...
		<footer>
			...
			<div class="copyright_container">
				<div id="copyright">
						<div> 
							<p> Copyright 2022 &copy; Handcrafted with love by <a href="#"> </a> Team </p>
